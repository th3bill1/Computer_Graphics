...
public partial class Tasks1and2Window : Window
{
    public static Tasks1and2Window? Instance { get; private set; }
    ...
    private void HSVConversion_Click(object sender, EventArgs e)
    {
        if (displayedImage == null)
            return;

        HSVWindow window = new(displayedImage);
        window.Show();
    }
}